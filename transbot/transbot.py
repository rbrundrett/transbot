...
def handle_trans_cmd(command, channel):
    ...
    #response = response + "{}".format(random.sample([ \
    #            " Also, I really don't think @tterdnurb should be punished further...", \
    #            " and really guys, don't you think @tterdnurb has been persecuted enough?", \
    #            " also, I remember when the Social Justice Tribunal focused on 'Justice' #freetterdnurb" \
    #            ],1)[0] )
